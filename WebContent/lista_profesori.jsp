...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      ...
      <table class="table table-bordered table-sm">
        ...
        %>  
          ...
          <%}
            ...
            <td><%=jb.numarDisciplinePerProfesor(x)%>  </td>
            <td><a href="vizualizare_profesor.jsp?id=<%=x%>" class="btn btn-primary float_right">Vizualizare</a></td>
          </tr>
          <%
            } 
          %>
      ...
      <a class="btn btn-primary float_right" href="modificare_profesor.jsp?value=add">Adauga Profesor</a>
      <%
            rs.close();
            jb.disconnect();
      %>
